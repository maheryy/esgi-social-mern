        ...
        <ul className="invisible-scrollbar h-full overflow-y-auto">
          {
            [...Array(10).keys()].map((_, key) => (
              <SidebarChatItem key={key} visible={sidebar} label={"Content flss"}/>
            ))
          }
        </ul>
      </div>
      <div className={"sm:block border-t border-gray-700 "}>
        <ul className="w-full flex items-center justify-around pt-4 pb-2 text-gray-300">
          <li className={"cursor-pointer px-2 hover:text-gray-500 " + (sidebar ? "" : "block")}>
            <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd"
          ...
          <li className={"cursor-pointer px-2 hover:text-gray-500 " + (sidebar ? "" : "hidden")}>
            <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd"
