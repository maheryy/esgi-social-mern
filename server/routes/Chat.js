...
// get all messages where isModerated = true
...
router.get("/moderated/:id", async (req, res) => {
  try {
...
router.put("/moderated/:id", async (req, res) => {
  try {
    const [affectedRows, [result]] = await Message.update(req.body, {
      where: {
